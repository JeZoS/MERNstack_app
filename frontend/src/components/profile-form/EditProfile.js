...
const EditProfile = ({profile:{profile ,loading},createProfile,getCurrentProfile , history}) => {
    ...
    useEffect(() => {
        getCurrentProfile();
        setFormData({
            company: loading || !profile.profile.company ? '' :profile.profile.company,
            website: loading || !profile.profile.website ? '' :profile.profile.website,
            ...
            skills: loading || !profile.profile.skills ? '' : profile.profile.skills.join(','),
            githubusername: loading || !profile.profile.githubusername ? '' : profile.profile.githubusername,
